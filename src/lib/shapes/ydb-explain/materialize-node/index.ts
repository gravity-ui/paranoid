...
export class MaterializeNodeShape implements Shape {
    ...
    private prepareNodeBody() {
        ...
        return new fabric.Polygon(
            [
                {x: NodeSize.bevelSize, y: 0},
                {x: NodeSize.width - NodeSize.bevelSize, y: 0},
                {x: NodeSize.width, y: NodeSize.bevelSize},
                {x: NodeSize.width, y: this.nodeHeight - NodeSize.bevelSize},
                {x: NodeSize.width - NodeSize.bevelSize, y: this.nodeHeight},
                {x: NodeSize.bevelSize, y: this.nodeHeight},
                {x: 0, y: this.nodeHeight - NodeSize.bevelSize},
                {x: 0, y: NodeSize.bevelSize},
            ],
            {
